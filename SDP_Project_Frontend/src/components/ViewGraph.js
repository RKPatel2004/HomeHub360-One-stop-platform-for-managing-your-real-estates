    ...
    useEffect(() => {
        const fetchViewData = async () => {
            try {
                ...
                const propertyTypeResponse = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/view-graph/views-by-property-type`, config);
                ...
                const locationResponse = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/view-graph/views-by-location`, config);
