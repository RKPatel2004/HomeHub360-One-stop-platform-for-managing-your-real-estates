...
//                                         <div className="rating-value">{currentFeedback?.rating || 'N/A'}<span className="rating-max">/5</span></div>
//                                     </div>
//                                 </div>
//                                 <div className="feedback-text">
//                                     <p>"{currentFeedback?.feedbackText || 'No feedback text provided'}"</p>
//                                 </div>
//                                 <div className="feedback-dots">
//                                     {feedbacks.map((_, index) => (
//                                         <span 
//                                             key={index} 
//                                             className={index === currentFeedbackIndex ? 'active-dot' : 'dot'}
//                                         />
//                                     ))}
//                                 </div>
//                             </div>
