...
function AdminDashboard() {
  ...
  const fetchMonthlyUsers = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/analytics/monthly-unique-users`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchProperties = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_BASE_URL}/api/getProperty`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const fetchPayments = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `${process.env.REACT_APP_BASE_URL}/api/payments/all`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
