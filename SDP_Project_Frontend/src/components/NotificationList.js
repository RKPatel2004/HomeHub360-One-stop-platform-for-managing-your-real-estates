...
const NotificationList = () => {
    ...
    useEffect(() => {
        const fetchNotifications = async () => {
            try {
                ...
                const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/notifications/user`, config);
                ...
                await Promise.all(uniquePropertyIds.map(async (propertyId) => {
                    if (propertyId) {
                        try {
                            ...
                            const propertyResponse = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/property/${propertyId}`, config);
                            const collectionName = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/property/type/${propertyId}`, config);
    ...
    const markAsRead = async (notificationId) => {
        try {
            ...
            await axios.put(`${process.env.REACT_APP_BASE_URL}/api/notifications/read/${notificationId}`, {}, config);
    ...
    const deleteNotification = async (notificationId) => {
        try {
            ...
            await axios.delete(`${process.env.REACT_APP_BASE_URL}/api/notifications/${notificationId}`, config);
