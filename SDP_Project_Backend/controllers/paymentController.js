...
exports.capturePayPalOrder = async (req, res) => {
  try {
    ...
    res.redirect(`https://frontend-0vfc.onrender.com/#/payment-success?orderId=${token}`/*`https://frontend-0vfc.onrender.com/#/payment-success?orderId=${token}`*/);
  } catch (error) {
    console.error('Error capturing PayPal payment:', error.response ? error.response.data : error);
    res.redirect(`https://frontend-0vfc.onrender.com/#/payment-cancel?error=${encodeURIComponent(error.message)}`/*`https://frontend-0vfc.onrender.com/#/payment-cancel?error=${encodeURIComponent(error.message)}`*/);
  }
};
...
exports.cancelPayPalOrder = async (req, res) => {
  try {
    ...
    res.redirect(`https://frontend-0vfc.onrender.com/#/payment-cancel`/*`https://frontend-0vfc.onrender.com/#/payment-cancel`*/);
  } catch (error) {
